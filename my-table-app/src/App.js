  ...
  return (
    <div className="App" style={{ display: 'flex' }}>
      ...
      <div className="content" style={{ flex: 1, padding: '10px' }}>
        {view === 'chart' && <Charts positiveChartData={positiveChartData} negativeChartData={negativeChartData} positiveTotal={positiveTotal} negativeTotal={negativeTotal} options={options} />}
